    ...
    <div class="container">
        ...
        <section class="content">
            <nav class="libraryLink">
                ...
                <a href="<?php echo $url; ?>SpaceUser/Artists">Artists</a>
                <a href="<?php echo $url; ?>SpaceUser/Albums" style="background: #333333;">Albums</a>
            ...
            <div class="content1">
                    ...
                    <div class="list">
                        ...
                        ?>
                            <a onclick="linkSpaceAlbum(<?php echo $value['id'] ?>)">
                                ...
                                <h4><?php if(strlen($value['nameAlbum'])>=14){echo substr($value['nameAlbum'],0,12)."...";}else{echo $value['nameAlbum'];} ?></h4>
                                <p><?php if(strlen($value['nameArtist'])>=14){echo substr($value['nameArtist'],0,12)."...";}else{echo $value['nameArtist'];}?></p>
                            </a>
                        <?php
                        }
                        ?>
                ...
                <div class="recent">
                    ...
                    <div class="list">
                        <?php
                        foreach ($_SESSION['albumsLike'] as $value) {
                        ?>
                            <a onclick="linkSpaceAlbum(<?php echo $value['id'] ?>)">
                                <img src="<?php echo $url; ?>public/SpaceUser/img/bg<?php echo rand(2,48); ?>.jpg" alt=""><br>
                                <h4><?php if(strlen($value['nameAlbum'])>=14){echo substr($value['nameAlbum'],0,12)."...";}else{echo $value['nameAlbum'];} ?></h4>
