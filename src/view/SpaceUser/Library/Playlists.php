    ...
    <div class="container">
        ...
        <section class="content">
            <nav class="libraryLink">
                ...
                <a href="<?php echo $url; ?>SpaceUser/Playlists" style="background: #333333;">Playlists</a>
                    ...
                    <div class="list">
                        ...
                        ?>
                            <a onclick="linkSpacePlaylist(<?php echo $value['id'];?>)">
                                ...
                                <h4><?php if(strlen($value['namePlaylist'])>=14){echo substr($value['namePlaylist'],0,12)."...";}else{echo $value['namePlaylist'];}?></h4>
