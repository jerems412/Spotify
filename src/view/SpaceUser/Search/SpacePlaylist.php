            ...
            <div class="content1">
                ...
                <div class="part2" style="background: #121212;">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th style="font-size: 40px;min-width: 100px;"><i class="fa-solid fa-circle-play" style="color:#1ed760;" id="playA"></i>&nbsp<i class="fa-solid fa-circle-minus" style="color:white;cursor:pointer;" onclick="deletePlaylist(<?php echo $_SESSION['SpacePlaylist']['id']; ?>)"></i></th>
                            </tr>
                            ...
                            ?>
                                <tr class="trMusique" id="musicDelete<?php echo $value['idArtist'] ?>">
                                    ...
                                    <td style="padding-right: 10px;border-radius: 0 4px 4px 0;"><i class="fa-solid fa-circle-minus" style="color:white;cursor:pointer;" onclick="deleteMusicPlaylist(<?php echo $value['id'] ?>)"></i></td>
                                </tr>
                            <?php
                            $i++;
                            }
