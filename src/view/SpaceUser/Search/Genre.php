...
<head>
    ...
    <title>Spotify - Genre Name</title>
    <!-- Liens -->
...
<body style="background: rgb(30 30 30);">
    <div class="container">
        <section class="menu" style="background:black;">
            ...
            <div class="liensMenu">
                <ul>
                    ...
                    <li><a href="<?php echo $url; ?>SpaceUser/Search" style="color:white;"><i class="fa-brands fa-searchengin"></i>&nbsp&nbsp&nbspSearch</a></li>
        ...
        <section class="content">
            ...
            <div class="content1">
                <div class="recent">
                    <h1 class="genre"><?php echo $_SESSION['Genre']['nameCategorie']; ?></h1>
