        ...
        <section class="menu" style="background:black;">
            ...
            <div class="liensMenu">
                <ul>
                    ...
                    <li><a href="<?php echo $url; ?>SpaceUser/Search" style="color:white;"><i class="fa-solid fa-magnifying-glass-plus"></i>&nbsp&nbsp&nbspSearch</a></li>
        ...
        <section class="content">
            <nav style="background:black;">
                ...
                <div class="inputSearch" style="background:white;">
                    ...
                    <input type="text" name="" id="" placeholder="Artists, songs, or podcasts" onkeyup="SearchValArtist(this);SearchVal(this)" onblur="addSearchVal(this)" />
                </div>
            ...
            <div class="content1">
                    ...
                    <div class="list">
                        ...
                        ?>
                            <a onclick="playSong(<?php echo $value['id']; ?>)">
                                ...
                                <h4><?php if (strlen($value['titre']) >= 14) {
                                        echo substr($value['titre'], 0, 12) . "...";
                                    } else {
                                        echo $value['titre'];
                                    } ?></h4>
                ...
                <div class="Search">
                    ...
                    <div class="listTopGenre">
                        <?php
                        foreach ($_SESSION['YourToCategorie'] as $value) {
                        ?>
                            <a onclick="linkGenre(<?php echo $value['id']; ?>)" style="background: <?php echo $value['color'] ?>;" value="<?php echo $value['id'] ?>"><?php echo $value['nameCategorie']; ?></a>
                        <?php
                        }
                        ?>
                    </div>
                ...
                <div class="Search">
                    ...
                    <div class="listBrowse">
                        <?php
                        foreach ($_SESSION['listCategorie'] as $value) {
                        ?>
                            <a onclick="linkGenre(<?php echo $value['id']; ?>)" style="background: <?php echo $value['color'] ?>;" value="<?php echo $value['id'] ?>"><?php echo $value['nameCategorie']; ?></a>
                        <?php
                        }
