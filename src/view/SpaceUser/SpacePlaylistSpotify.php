...
<head>
    ...
    <title>Spotify - <?php echo $_SESSION['SpacePlaylistSpotify']['namePlaylist']; ?></title>
    <!-- Liens -->
        ...
        <section class="content">
            ...
            <div class="content1">
                <div class="part1">
                    ...
                    <ul>
                        <li>PLAYLIST</li>
                        <li><?php echo $_SESSION['SpacePlaylistSpotify']['namePlaylist']; ?></li>
                        <li><?php echo $_SESSION['SpacePlaylistSpotify']['description']; ?></li>
                    </ul>
                </div>
                <div class="part2" style="background: #121212;">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th style="font-size: 40px;min-width: 100px;"><i class="fa-solid fa-circle-play" style="color:#1ed760;" id="playA"></i>&nbsp<i class="fa-solid fa-heart" style="color:<?php if($_SESSION['likePlaylist']){echo "#1ed760";}else{echo "white";} ?>;" id="likeAlbum" onclick="likedPlaylists(<?php echo $_SESSION['SpacePlaylistSpotify']['id']; ?>)"></i></th>
                            </tr>
